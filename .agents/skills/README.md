...
| `dotnet-service-change` | parcialmente aplicavel | Mudancas na solution .NET atual ou na migracao tecnica, respeitando o estado real. | Governanca pura ou mudancas sem impacto tecnico. | `WebApiCoreSeed.slnx`, projetos reais |
...
- A origem, revisao e licenca das skills Docker estao em `DOCKER-SKILLS-SOURCE.md`.
