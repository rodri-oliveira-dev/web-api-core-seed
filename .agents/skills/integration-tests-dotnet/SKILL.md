...
No estado atual, o repositorio possui testes unitarios/leves em `tests/WebApiCoreSeed.UnitTests` e testes de integracao/container em `tests/WebApiCoreSeed.IntegrationTests`.
