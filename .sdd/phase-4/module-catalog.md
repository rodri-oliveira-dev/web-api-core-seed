...
| Contratos publicos | Endpoints HTTP versionados atuais em `/api/v{version}`; view models permanecem na API nesta entrega. |
...
| Maturidade do limite | Inicial. O limite fisico foi introduzido de forma pragmatica; separacoes mais finas estao planejadas para os prompts seguintes. |
...
| Dependencias proibidas | Nao deve acessar detalhes internos do modulo `Restaurant`; nao deve depender dos repositorios de restaurante. |
