...
namespace Restaurante.IO.Api.Configuration.OpenApi
{
    public static class OpenApiConfig
    {
        private const string BearerScheme = "Bearer";

        public static VersionedOpenApiOptions ConfigureRestauranteOpenApi(this VersionedOpenApiOptions options)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            document.Info.Title = "API - Restaurante";
            document.Info.Version = description;
            document.Info.Description = "Esta API atende as tratativas necessarias para um restaurante.";
