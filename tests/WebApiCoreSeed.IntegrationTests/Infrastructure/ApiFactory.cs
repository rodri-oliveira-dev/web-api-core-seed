...
public sealed class ApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configuration) =>
        {
            configuration.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["DevelopmentSeed:User:Email"] = "developer@example.local",
                ["DevelopmentSeed:User:Password"] = "NotASecret_ForTests_2026!",
    ...
    private Dictionary<string, string> CreateConfigurationOverrides()
    {
        return new Dictionary<string, string>
        {
            ...
            ["DevelopmentSeed__User__Email"] = "developer@example.local",
            ["DevelopmentSeed__User__Password"] = "NotASecret_ForTests_2026!",
